...
use LiteAPI\Model\ModelInterface;
...
class ObjectSerializer
{
     ...
     * @param string $type   the liteApiType of the data
     * @param string $format the format of the liteApiType type of the data
     *
    ...
    /**
     * Checks if a value is empty, based on its LiteAPI type.
     *
     * @param mixed  $value
    ...
    public static function toQueryValue(
        ...
        #  - its value is set to a value that is equivalent to "empty", depending on its LiteAPI type. For
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\LiteAPI\Model\\' . $data->{$discriminator};
